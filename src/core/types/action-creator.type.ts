...
export type ActionCreator<A extends Action<any, any, any, any>> = ActionPayload<A> extends undefined
...
export interface PayloadActionCreator<A extends Action<any, any, any, any>>
...
export interface NakedActionCreator<A extends Action<any, undefined, any, any>> extends WithActionType<ActionType<A>> {
    (): {
        type: ActionType<A>
        payload: undefined
        reducer: ActionReducer<ActionState<A>, ActionPayload<A>>
